...
gj.widget = function () {
  ...
  var a = this
  return function (b) {
    typeof b === 'string' && JSON && (b = JSON.parse(b)), gj[a.data('type')].methods.render(a, b)
  }
  ...
  var b; var c; var d = this.data()
  var e = this.data('type')
  return void 0 === d.dataSource && gj[e].methods.useHtmlDataSource(this, d), $.extend(d.params, a), $.isArray(d.dataSource) ? (c = gj[e].methods.filter(this), gj[e].methods.render(this, c)) : typeof d.dataSource === 'string' ? (b = {
    url: d.dataSource,
    data: d.params
  }, this.xhr && this.xhr.abort(), this.xhr = $.ajax(b).done(this.createDoneHandler()).fail(this.createErrorHandler())) : typeof d.dataSource === 'object' && (d.dataSource.data || (d.dataSource.data = {}), $.extend(d.dataSource.data, d.params), b = $.extend(!0, {}, d.dataSource), b.dataType === 'json' && typeof b.data === 'object' && (b.data = JSON.stringify(b.data)), b.success || (b.success = this.createDoneHandler()), b.error || (b.error = this.createErrorHandler()), this.xhr && this.xhr.abort(), this.xhr = $.ajax(b)), this
}, gj.documentManager = {
  events: {},
  subscribeForEvent: function (a, b, c) {
    if (gj.documentManager.events[a] && gj.documentManager.events[a].length !== 0) {
  ...
  unsubscribeForEvent: function (a, b) {
    var c = !1
    var d = gj.documentManager.events[a]
    if (d) { for (var e = 0; e < d.length; e++) d[e].widgetId === b && (d.splice(e, 1), c = !0, d.length === 0 && ($(document).off(a), delete gj.documentManager.events[a])) }
  ...
  parseDate: function (a, b, c) {
    var d; var e; var f; var g; var h = 0
    var i = 0
    var j = 0
    var k = 0
    var l = 0
    if (a && typeof a === 'string') {
      if (/^\d+$/.test(a)) g = new Date(a)
        ...
        for (e = a.split(/[\s,-\.\/\/\:]+/), f = b.split(/[\s,-\.\/\/\:]+/), d = 0; d < f.length; d++)['d', 'dd'].indexOf(f[d]) > -1 ? j = parseInt(e[d], 10) : ['m', 'mm'].indexOf(f[d]) > -1 ? i = parseInt(e[d], 10) - 1 : f[d] === 'mmm' ? i = gj.core.messages[c || 'en-us'].monthShortNames.indexOf(e[d]) : f[d] === 'mmmm' ? i = gj.core.messages[c || 'en-us'].monthNames.indexOf(e[d]) : ['yy', 'yyyy'].indexOf(f[d]) > -1 ? (h = parseInt(e[d], 10), f[d] === 'yy' && (h += 2e3)) : ['h', 'hh', 'H', 'HH'].indexOf(f[d]) > -1 ? k = parseInt(e[d], 10) : ['M', 'MM'].indexOf(f[d]) > -1 && (l = parseInt(e[d], 10))
        g = new Date(h, i, j, k, l)
      }
    } else typeof a === 'number' ? g = new Date(a) : a instanceof Date && (g = a)
    return g
  },
  formatDate: function (a, b, c) {
    var d; var e; var f = ''
    var g = b.split(/[\s,-\.\/\/\:]+/)
    var h = b.split(/s+|M+|H+|h+|t+|T+|d+|m+|y+/)
  ...
  center: function (a) {
    ...
    var c = $(window).height() / 2 - a.height() / 2
  ...
  setChildPosition: function (a, b) {
    ...
    var d = gj.core.height(a, !0)
    var e = gj.core.height(b, !0)
    var f = gj.core.width(a, !0)
    var g = gj.core.width(b, !0)
    var h = window.scrollY || window.pageYOffset || 0
    var i = window.scrollX || window.pageXOffset || 0
  ...
  height: function (a, b) {
    var c; var d = window.getComputedStyle(a)
    return d.boxSizing === 'border-box' ? c = parseInt(d.height, 10) : (c = parseInt(d.height, 10), c += parseInt(d.paddingTop || 0, 10) + parseInt(d.paddingBottom || 0, 10), c += parseInt(d.borderTop || 0, 10) + parseInt(d.borderBottom || 0, 10)), b && (c += parseInt(d.marginTop || 0, 10) + parseInt(d.marginBottom || 0, 10)), c
  },
  width: function (a, b) {
    var c; var d = window.getComputedStyle(a)
    return d.boxSizing === 'border-box' ? c = parseInt(d.width, 10) : (c = parseInt(d.width, 10), c += parseInt(d.paddingLeft || 0, 10) + parseInt(d.paddingRight || 0, 10), c += parseInt(d.borderLeft || 0, 10) + parseInt(d.borderRight || 0, 10)), b && (c += parseInt(d.marginLeft || 0, 10) + parseInt(d.marginRight || 0, 10)), c
  },
  ...
  position: function (a, b, c) {
    ...
    var h = window.pageYOffset || g.scrollTop || e.scrollTop
    var i = window.pageXOffset || g.scrollLeft || e.scrollLeft
    var j = g.clientTop || e.clientTop || 0
    var k = g.clientLeft || e.clientLeft || 0
    var l = Math.round(d.top + h - j)
    var m = Math.round(d.left + i - k)
  ...
  initialize: function (a) {
    var b; var c; var d; var e = a.data()
    a.addClass(e.style.content), gj.dialog.methods.setSize(a), e.closeOnEscape && $(document).keyup(function (b) {
      b.keyCode === 27 && a.close()
    }), c = a.children('div[data-role="body"]'), c.length === 0 ? (c = $('<div data-role="body"/>').addClass(e.style.body), a.wrapInner(c)) : c.addClass(e.style.body), b = gj.dialog.methods.renderHeader(a), d = a.children('div[data-role="footer"]').addClass(e.style.footer), a.find('[data-role="close"]').on('click', function () {
      a.close()
  ...
  renderHeader: function (a) {
    var b; var c; var d; var e = a.data()
    return b = a.children('div[data-role="header"]'), b.length === 0 && (b = $('<div data-role="header" />'), a.prepend(b)), b.addClass(e.style.header), c = b.find('[data-role="title"]'), c.length === 0 && (c = $('<h4 data-role="title">' + e.title + '</h4>'), b.append(c)), c.addClass(e.style.headerTitle), d = b.find('[data-role="close"]'), d.length === 0 && e.closeButtonInHeader ? (d = $('<button type="button" data-role="close" title="' + gj.dialog.messages[e.locale].Close + '"><span>×</span></button>'), d.addClass(e.style.headerCloseButton), b.append(d)) : d.length > 0 && !1 === e.closeButtonInHeader ? d.hide() : d.addClass(e.style.headerCloseButton), b
  },
  ...
  resize: function (a, b) {
    var c; var d; var e; var f; var g; var h; var i; var j; var k = !1
  ...
  }, $.extend(a, c), a.attr('data-type') !== 'dialog' && d.init.call(a, b), a
...
(function (a) {
  ...
  createUpHandler: function (a) {
    return function (b) {
      a.attr('draggable-dragging') === 'true' && (a.attr('draggable-dragging', !1), gj.documentManager.unsubscribeForEvent('mousemove', a.data('guid')), gj.documentManager.unsubscribeForEvent('touchmove', a.data('guid')), gj.draggable.events.stop(a, {
        x: a.mouseX(b),
        y: a.mouseY(b)
      }))
    }
  ...
  move: function (a, b, c, d, e, f) {
    var g; var h; var i; var j = gj.core.position(a)
    var k = j.top + d
    var l = j.left + c
  ...
  destroy: function (a) {
    return a.attr('data-draggable') === 'true' && (gj.documentManager.unsubscribeForEvent('mouseup', a.data('guid')), a.removeData(), a.removeAttr('data-guid'), a.removeAttr('data-draggable'), a.off('drag').off('start').off('stop'), gj.draggable.methods.getHandleElement(a).off('mousedown')), a
  }
}, gj.draggable.events = {
  ...
  var c = this
  var d = gj.draggable.methods
  return a.destroy || (c.destroy = function () {
    return d.destroy(this)
  }), $.extend(a, c), a.attr('data-draggable') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  createMouseMoveHandler: function (a) {
    return function (b) {
      if (a.isDragging) {
        ...
        var e = gj.droppable.methods.isOver(a, d)
  ...
  destroy: function (a) {
    return a.attr('data-droppable') === 'true' && (gj.documentManager.unsubscribeForEvent('mousedown', a.data('guid')), gj.documentManager.unsubscribeForEvent('mousemove', a.data('guid')), gj.documentManager.unsubscribeForEvent('mouseup', a.data('guid')), a.removeData(), a.removeAttr('data-guid'), a.removeAttr('data-droppable'), a.off('drop').off('over').off('out')), a
  }
}, gj.droppable.events = {
  drop: function (a, b, c) {
    a.trigger('drop', [{
  ...
  var c = this
  var d = gj.droppable.methods
  return c.isOver = !1, c.isDragging = !1, c.destroy = function () {
    return d.destroy(this)
  }, c.isOver = function (a) {
    return d.isOver(this, a)
  }, $.extend(a, c), a.attr('data-droppable') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a) {
    var b = a.data()
    var c = a.parent('div[data-role="wrapper"]')
    gj.grid.methods.localization(b), c.length === 0 ? (c = $('<div data-role="wrapper" />').addClass(b.style.wrapper), a.wrap(c)) : c.addClass(b.style.wrapper), b.width && a.parent().css('width', b.width), b.minWidth && a.css('min-width', b.minWidth), b.fontSize && a.css('font-size', b.fontSize), b.headerRowHeight === 'autogrow' && a.addClass('autogrow-header-row'), b.bodyRowHeight === 'fixed' && a.addClass('fixed-body-rows'), a.addClass(b.style.table), b.selectionMethod === 'checkbox' && b.columns.splice(gj.grid.methods.getColumnPositionNotInRole(a), 0, {
      title: '',
      ...
      stopPropagation: !0
    }), a.children('tbody').length === 0 && a.append($('<tbody/>')), gj.grid.methods.renderHeader(a), gj.grid.methods.appendEmptyRow(a, '&nbsp;'), gj.grid.events.initialized(a)
  },
  localization: function (a) {
  ...
  renderHeader: function (a) {
    ...
    for (b = a.data(), c = b.columns, d = b.style.header, e = a.children('thead'), e.length === 0 && (e = $('<thead />'), a.prepend(e)), f = $('<tr data-role="caption" />'), i = 0; i < c.length; i += 1) {
  ...
  createSortHandler: function (a, b) {
    return function () {
      var c; var d = {}
      a.count() > 0 && (c = a.data(), d[c.paramNames.sortBy] = b.field, b.direction = b.direction === 'asc' ? 'desc' : 'asc', d[c.paramNames.direction] = b.direction, a.reload(d))
    }
  },
  updateHeader: function (a) {
    var b; var c; var d = a.data()
    var e = d.params[d.paramNames.sortBy]
    var f = d.params[d.paramNames.direction]
    a.find('thead tr th [data-role="sorticon"]').remove(), e && (position = gj.grid.methods.getColumnPosition(a.data('columns'), e), position > -1 && (c = a.find('thead tr th:eq(' + position + ') div[data-role="title"]'), b = $('<div data-role="sorticon" class="gj-unselectable" />').append(f === 'desc' ? d.icons.desc : d.icons.asc), c.after(b)))
  },
  useHtmlDataSource: function (a, b) {
    var c; var d; var e; var f; var g = []
    var h = a.find('tbody tr[data-role != "empty"]')
  ...
  startLoading: function (a) {
    var b, c, d, e, f, g, h
    gj.grid.methods.stopLoading(a), h = a.data(), a.outerHeight() !== 0 && (b = a.children('tbody'), e = b.outerWidth(!1), f = b.outerHeight(!1), g = Math.abs(a.parent().offset().top - b.offset().top), c = $('<div data-role="loading-cover" />').addClass(h.style.loadingCover).css({
      width: e,
      height: f,
      top: g
  ...
  autoGenerateColumns: function (a, b) {
    var c; var d; var e; var f; var g = a.data()
    if (g.columns = [], b.length > 0) {
      for (c = Object.getOwnPropertyNames(b[0]), f = 0; f < c.length; f++) {
        d = b[0][c[f]], e = 'text', d && (typeof d === 'number' ? e = 'number' : d.indexOf('/Date(') > -1 && (e = 'date')), g.columns.push({
          field: c[f],
          type: e
        })
      }
  ...
  renderRow: function (a, b, c, d) {
    var e, f, g, h, i
    for (h = a.data(), b && b.length !== 0 ? (i = 'update', b.removeClass(h.style.content.rowSelected).removeAttr('data-selected').off('click')) : (i = 'create', b = $('<tr data-role="row"/>'), a.children('tbody').append(b)), e = gj.grid.methods.getId(c, h.primaryKey, d + 1), b.attr('data-position', d + 1), h.selectionMethod !== 'checkbox' && b.on('click', gj.grid.methods.createRowClickHandler(a, e)), g = 0; g < h.columns.length; g++) i === 'update' ? (f = b.find('td:eq(' + g + ')'), gj.grid.methods.renderCell(a, f, h.columns[g], c, e)) : (f = gj.grid.methods.renderCell(a, null, h.columns[g], c, e), b.append(f))
    gj.grid.events.rowDataBound(a, b, e, c)
  },
  renderCell: function (a, b, c, d, e, f) {
    var g, h
    if (b && b.length !== 0 ? (g = b.find('div[data-role="display"]'), f = 'update') : (b = $('<td/>'), g = $('<div data-role="display" />'), c.align && b.css('text-align', c.align), c.cssClass && b.addClass(c.cssClass), b.append(g), f = 'create'), gj.grid.methods.renderDisplayElement(a, g, c, d, e, f), f === 'update' && (b.off(), g.off()), c.events) {
      for (h in c.events) {
  ...
  renderDisplayElement: function (a, b, c, d, e, f) {
    var g, h
    c.type === 'checkbox' && gj.checkbox ? f === 'create' ? (h = $('<input type="checkbox" />').val(e).prop('checked', !!d[c.field]), c.role && h.attr('data-role', c.role), b.append(h), h.checkbox({
      uiLibrary: a.data('uiLibrary')
    }), c.role === 'selectRow' ? h.on('click', function () {
      return !1
    }) : h.prop('disabled', !0)) : b.find('input[type="checkbox"]').val(e).prop('checked', !!d[c.field]) : c.type === 'icon' ? f === 'create' && (b.append($('<span/>').addClass(c.icon).css({
      cursor: 'pointer'
    })), a.data().uiLibrary === 'bootstrap' && b.children('span').addClass('glyphicon'), c.stopPropagation = !0) : c.tmpl ? (g = c.tmpl, c.tmpl.replace(/\{(.+?)\}/g, function (a, b) {
      g = g.replace(a, gj.grid.methods.formatText(d[b], c))
    }), b.html(g)) : c.renderer && typeof c.renderer === 'function' ? (g = c.renderer(d[c.field], d, b.parent(), b, e, a)) && b.html(g) : (d[c.field] = gj.grid.methods.formatText(d[c.field], c), !c.tooltip && d[c.field] && b.attr('title', d[c.field]), b.html(d[c.field])), c.tooltip && f === 'create' && b.attr('title', c.tooltip)
  },
  formatText: function (a, b) {
    return a = a && b.type === 'date' ? gj.core.formatDate(gj.core.parseDate(a, b.format), b.format) : void 0 === a || a === null ? '' : a.toString(), b.decimalDigits && a && (a = parseFloat(a).toFixed(b.decimalDigits)), a
  },
  ...
  unselectRow: function (a, b, c, d) {
    var e
    if (c.attr('data-selected') === 'true') return c.removeClass(b.style.content.rowSelected), b.selectionMethod === 'checkbox' && (e = c.find('td input[type="checkbox"][data-role="selectRow"]'), e.length && e.prop('checked') && e.prop('checked', !1), b.selectionType === 'multiple' && a.find('thead input[data-role="selectAll"]').prop('checked', !1)), c.removeAttr('data-selected'), gj.grid.events.rowUnselect(a, c, d, a.getById(d))
  },
  setSelected: function (a, b, c) {
    var d = a.data()
    return c && c.length || (c = gj.grid.methods.getRowById(a, b)), c && (c.attr('data-selected') === 'true' ? gj.grid.methods.unselectRow(a, d, c, b) : (d.selectionType === 'single' && c.siblings('[data-selected="true"]').each(function () {
      var b = $(this)
      var c = gj.grid.methods.getId(b, d.primaryKey, b.data('position'))
  ...
  selectAll: function (a) {
    ...
    return a.find('tbody tr[data-role="row"]').each(function () {
      var c = $(this)
      var d = c.data('position')
      var e = a.get(d)
      var f = gj.grid.methods.getId(e, b.primaryKey, d)
  ...
  getSelections: function (a) {
    var b; var c; var d = []
    var e = a.data()
    var f = gj.grid.methods.getSelectedRows(a)
    return f.length > 0 && f.each(function () {
      b = $(this).data('position'), c = a.get(b), d.push(gj.grid.methods.getId(c, e.primaryKey, b))
    }), d
  },
  getById: function (a, b) {
    var c; var d = null
    var e = a.data('primaryKey')
    var f = a.data('records')
    if (e) {
  ...
  getRowById: function (a, b) {
    var c; var d; var e = a.getAll(!1)
    var f = a.data('primaryKey')
    var g = void 0
    if (f) {
  ...
  setCellContent: function (a, b, c, d) {
    var e; var f = gj.grid.methods.getCell(a, b, c)
    f && (f.empty(), typeof d === 'object' ? f.append(d) : (e = gj.grid.methods.getColumnInfo(a, c), gj.grid.methods.renderDisplayElement(a, f, e, a.getById(b), b, 'update')))
  },
  clone: function (a) {
    var b = []
  ...
  filter: function (a) {
    ...
    for (b in d.params) {
      d.params[b] && !d.paramNames[b] && (c = gj.grid.methods.getColumnInfo(a, b), e = $.grep(e, function (a) {
        var e = a[b] || ''
        var f = d.params[b] || ''
        return c && typeof c.filter === 'function' ? c.filter(e, f) : e.toUpperCase().indexOf(f.toUpperCase()) > -1
      }))
    }
  ...
  showColumn: function (a, b) {
    var c; var d = a.data()
    var e = gj.grid.methods.getColumnPosition(d.columns, b)
  ...
  addRow: function (a, b) {
    var c = a.data()
    return c.totalRecords = a.data('totalRecords') + 1, gj.grid.events.dataBinding(a, [b]), c.records.push(b), $.isArray(c.dataSource) && c.dataSource.push(b), c.totalRecords === 1 && a.children('tbody').empty(), gj.grid.methods.isLastRecordVisible(a) && gj.grid.methods.renderRow(a, null, b, a.count() - 1), gj.grid.events.dataBound(a, [b], c.totalRecords), a
  },
  updateRow: function (a, b, c) {
    var d; var e = gj.grid.methods.getRowById(a, b)
    var f = a.data()
  ...
  removeRow: function (a, b) {
    var c; var d = a.data()
    var e = gj.grid.methods.getRowById(a, b)
  ...
  getColumnPositionByRole: function (a, b) {
    var c; var d; var e = a.data('columns')
  ...
  }, $.extend(a, c), a.attr('data-type') !== 'grid' && d.init.call(a, b), a
...
(function (a) {
  ...
  private: {
    init: function (a) {
      ...
      var e = b.height - d.outerHeight() - (a.children('tfoot').outerHeight() || 0)
      a.addClass('gj-grid-scrollable'), c.css('width', d.outerWidth()), c.height(e)
    },
    refresh: function (a) {
      var b; var c; var d = (a.data(), a.children('tbody'))
      var e = a.children('thead')
      var f = a.find('tbody tr[data-role="row"] td')
      var g = a.find('thead tr[data-role="caption"] th')
      for (a.children('tbody').height() < gj.grid.plugins.fixedHeader.private.getRowsHeight(a) ? d.css('width', e.outerWidth() + gj.grid.plugins.fixedHeader.private.getScrollBarWidth() + (navigator.userAgent.toLowerCase().indexOf('firefox') > -1 ? 1 : 0)) : d.css('width', e.outerWidth()), b = 0; b < g.length; b++) c = $(g[b]).outerWidth(), b === 0 && gj.core.isIE() && (c -= 1), $(f[b]).attr('width', c)
    },
  ...
  private: {
    expandDetail: function (a, b, c) {
      var d = b.closest('tr')
      var e = $('<tr data-role="details" />')
      var f = $('<td colspan="' + gj.grid.methods.countVisibleColumns(a) + '" />')
      var g = $('<div data-role="display" />')
      var h = a.data()
      var i = d.data('position')
      var j = a.get(i)
      var k = gj.grid.plugins.expandCollapseRows
    ...
    collapseDetail: function (a, b, c) {
      var d = b.closest('tr')
      var e = d.next('tr[data-role="details"]')
      var f = a.data()
      var g = gj.grid.plugins.expandCollapseRows
    ...
    keepSelection: function (a, b) {
      var c = a.data()
      c.keepExpandedRows && ($.isArray(c.expandedRows) ? c.expandedRows.indexOf(b) == -1 && c.expandedRows.push(b) : c.expandedRows = [b])
    },
  ...
  public: {
    ...
    updateDetails: function (a) {
      var b = this
      var c = a.data('details')
      var d = c.html()
      var e = b.get(a.data('position'))
  ...
  configure: function (a) {
    ...
    $.extend(!0, a, gj.grid.plugins.expandCollapseRows.public), void 0 !== c.detailTemplate && (b = {
      ...
      events: {
        click: function (b) {
          var c = $(this)
          var d = gj.grid.plugins.expandCollapseRows.private
          c.closest('tr').next().attr('data-role') === 'details' ? d.collapseDetail(a, c, b.data.id) : d.expandDetail(a, $(this), b.data.id)
        }
      }
      ...
      var b; var c; var d; var e; var f = a.data()
  ...
  renderers: {
    editManager: function (a, b, c, d, e, f) {
      var g = f.data()
      var h = $(g.inlineEditing.editButton).attr('key', e)
      var i = $(g.inlineEditing.deleteButton).attr('key', e)
      var j = $(g.inlineEditing.updateButton).attr('key', e).hide()
      var k = $(g.inlineEditing.cancelButton).attr('key', e).hide()
  ...
  editMode: function (a, b, c, d) {
    var e; var f; var g; var h; var i; var j = a.data()
    b.attr('data-mode') !== 'edit' && (c.editor ? (gj.grid.plugins.inlineEditing.private.updateOtherCells(a, c.mode), e = b.find('div[data-role="display"]').hide(), f = b.find('div[data-role="edit"]').show(), f.length === 0 && (f = $('<div data-role="edit" />'), b.append(f)), h = d[c.editField || c.field], g = f.find('input, select, textarea').first(), g.length ? c.type === 'checkbox' ? g.prop('checked', h) : g.val(h) : (typeof c.editor === 'function' ? (c.editor(f, h, d), g = f.find('input, select, textarea').first()) : (i = typeof c.editor === 'object' ? c.editor : {}, i.uiLibrary = j.uiLibrary, i.iconsLibrary = j.iconsLibrary, i.fontSize = a.css('font-size'), c.type === 'checkbox' && gj.checkbox ? (g = $('<input type="checkbox" />').prop('checked', h), f.append(g), g.checkbox(i)) : c.type === 'date' && gj.datepicker ? (g = $('<input type="text" width="100%"/>'), f.append(g), c.format && (i.format = c.format), g = g.datepicker(i), g.value && g.value(e.html())) : c.type === 'dropdown' && gj.dropdown ? (g = $('<select type="text" width="100%"/>'), f.append(g), i.dataBound = function (a) {
      var b = $(this).dropdown()
      c.editField ? b.value(d[c.editField]) : b.value(d[c.field])
    }, g = g.dropdown(i)) : (g = $('<input type="text" value="' + h + '" class="gj-width-full"/>'), j.uiLibrary === 'materialdesign' && g.addClass('gj-textbox-md').css('font-size', a.css('font-size')), f.append(g))), j.inlineEditing.mode !== 'command' && c.mode !== 'editOnly' && (g = f.find('input, select, textarea').first(), g.on('keyup', function (d) {
      d.keyCode !== 13 && d.keyCode !== 27 || gj.grid.plugins.inlineEditing.private.displayMode(a, b, c)
    }))), g.prop('tagName').toUpperCase() === 'INPUT' && g.prop('type').toUpperCase() === 'TEXT' ? gj.grid.plugins.inlineEditing.private.setCaretAtEnd(g[0]) : g.focus(), b.attr('data-mode', 'edit')) : c.role === 'managementColumn' && (b.find('[role="edit"]').hide(), b.find('[role="delete"]').hide(), b.find('[role="update"]').show(), b.find('[role="cancel"]').show()))
  },
  setCaretAtEnd: function (a) {
    ...
    if (a) {
      ...
      } else (a.selectionStart || a.selectionStart == '0') && (a.selectionStart = b, a.selectionEnd = b, a.focus())
    }
  },
  displayMode: function (a, b, c, d) {
    var e, f, g, h, i, j, k
    c.mode !== 'editOnly' && (b.attr('data-mode') === 'edit' && (e = b.find('div[data-role="edit"]'), f = b.find('div[data-role="display"]'), g = e.find('input, select, textarea').first(), g[0].tagName.toUpperCase() === 'SELECT' && g[0].selectedIndex > -1 ? (h = g[0].options[g[0].selectedIndex].innerHTML, i = g[0].value) : h = g[0].tagName.toUpperCase() === 'INPUT' && g[0].type.toUpperCase() === 'CHECKBOX' ? g[0].checked : g.val(), k = b.parent().data('position'), j = a.get(k), !0 !== d && h !== j[c.field] && (j[c.field] = c.type === 'date' ? gj.core.parseDate(h, c.format) : h, c.editField && (j[c.editField] = i || h), c.mode !== 'editOnly' && (gj.grid.methods.renderDisplayElement(a, f, c, j, gj.grid.methods.getId(j, a.data('primaryKey'), k), 'update'), b.find('span.gj-dirty').length === 0 && b.prepend($('<span class="gj-dirty" />'))), gj.grid.plugins.inlineEditing.events.cellDataChanged(a, b, c, j, h), gj.grid.plugins.inlineEditing.private.updateChanges(a, c, j, h)), e.hide(), f.show(), b.attr('data-mode', 'display')), c.role === 'managementColumn' && (b.find('[role="update"]').hide(), b.find('[role="cancel"]').hide(), b.find('[role="edit"]').show(), b.find('[role="delete"]').show()))
  },
  updateOtherCells: function (a, b) {
    var c = a.data()
    c.inlineEditing.mode !== 'command' && b !== 'editOnly' && a.find('div[data-role="edit"]:visible').parent('td').each(function () {
      var b = $(this)
      var d = c.columns[b.index()]
      gj.grid.plugins.inlineEditing.private.displayMode(a, b, d)
    })
  },
  updateChanges: function (a, b, c, d) {
    var e; var f; var g; var h = a.data()
    ...
    }) : e = [], f && f.length === 1 ? f[0][b.field] = d : (g = {}, g[h.primaryKey] = c[h.primaryKey], h.primaryKey !== b.field && (g[b.field] = d), e.push(g)), sessionStorage.setItem('gj.grid.' + h.guid, JSON.stringify(e)))
  },
  ...
  edit: function (a) {
    var b; var c = this.getById(a)
    var d = gj.grid.methods.getRowById(this, a).children('td')
    var e = this.data('columns')
  ...
  cancel: function (a) {
    var b; var c = (this.getById(a), gj.grid.methods.getRowById(this, a).children('td'))
  ...
  $.extend(!0, a, gj.grid.plugins.inlineEditing.public), c.inlineEditing && (a.on('dataBound', function () {
    ...
    a.cancel(d)
  })), d.inlineEditing.mode === 'command' ? (gj.grid.plugins.inlineEditing.private.localization(d), b.inlineEditing.managementColumn && d.columns.push(b.inlineEditing.managementColumnConfig)) : a.on('cellDataBound', function (b, c, e, f, g) {
    f.editor && (f.mode === 'editOnly' ? gj.grid.plugins.inlineEditing.private.editMode(a, c.parent(), f, g) : c.parent('td').on(d.inlineEditing.mode === 'dblclick' ? 'dblclick' : 'click', function () {
  ...
  private: {
    ...
    localization: function (a) {
      a.uiLibrary === 'bootstrap' ? gj.grid.plugins.pagination.private.localizationBootstrap(a) : a.uiLibrary === 'bootstrap4' ? gj.grid.plugins.pagination.private.localizationBootstrap4(a) : gj.grid.plugins.pagination.private.localizationMaterialDesign(a)
    },
    ...
    initPagerControl: function (a, b) {
      ...
      switch (a.data('role')) {
        case 'page-size':
          c.pager.sizes && c.pager.sizes.length > 0 ? (a.show(), $.each(c.pager.sizes, function () {
    ...
    reloadPager: function (a, b) {
      var c, d, e, f, g, h, i, j
      if (h = a.data(), h.pager) {
        for (c = b === 0 ? 0 : parseInt(h.params[h.paramNames.page], 10), d = parseInt(h.params[h.paramNames.limit], 10), e = Math.ceil(b / d), f = c === 0 ? 0 : d * (c - 1) + 1, g = f + d > b ? b : f + d - 1, i = a.find('TFOOT [data-role]'), j = 0; j < i.length; j++) gj.grid.plugins.pagination.private.reloadPagerControl($(i[j]), a, c, e, f, g, b)
    ...
    reloadPagerControl: function (a, b, c, d, e, f, g) {
      ...
      switch (a.data('role')) {
        ...
        case 'page-button-one':
          h = c === 1 ? 1 : c == d ? c - 2 : c - 1, gj.grid.plugins.pagination.private.assignButtonHandler(b, a, c, h, d)
          break
        case 'page-button-two':
          h = c === 1 ? 2 : c == d ? d - 1 : c, gj.grid.plugins.pagination.private.assignButtonHandler(b, a, c, h, d)
          break
        case 'page-button-three':
          h = c === 1 ? c + 2 : c == d ? c : c + 1, gj.grid.plugins.pagination.private.assignButtonHandler(b, a, c, h, d)
          break
        case 'record-first':
          a.text(e)
          break
    ...
    isLastRecordVisible: function (a) {
      var b = !0
      var c = a.data()
      var d = parseInt(c.params[c.paramNames.limit], 10)
      var e = parseInt(c.params[c.paramNames.page], 10)
      var f = a.count()
  ...
  public: {
    getAll: function (a) {
      var b; var c; var d; var e = this.data()
  ...
  public: {
    ...
    makeResponsive: function () {
      var a; var b; var c = 0
      var d = this.data()
      var e = gj.grid.plugins.responsiveDesign.private.orderColumns(d)
  ...
  private: {
    ...
    createResizeHandle: function (a, b, c) {
      var d = a.data()
      return function (e, f) {
        var g; var h; var i; var j; var k; var l; var m = parseInt(b.attr('width'), 10)
        var n = gj.core.position(this)
        var o = {
          top: f.top - n.top,
          left: f.left - n.left
        }
  ...
  private: {
    init: function (a) {
      var b; var c; var d; var e = a.find('tbody tr[data-role="row"]')
    ...
    createRowMouseDownHandler: function (a, b) {
      return function (c) {
        var d; var e; var f = a.clone()
        var g = a.data('columns')
        ...
        f.draggable({
          ...
          width: b.width(),
          zIndex: 1
        }), b.attr('data-droppable') === 'true' && b.droppable('destroy'), b.siblings('tr[data-role="row"]').each(function () {
          var a = $(this)
          a.attr('data-droppable') === 'true' && a.droppable('destroy'), a.droppable({
    ...
    createDragStopHandler: function (a, b) {
      return function (c, d) {
        $('table[data-role="draggable-clone"]').draggable('destroy').remove(), a.removeClass('gj-unselectable'), b.siblings('tr[data-role="row"]').each(function () {
          var c; var e; var f; var g; var h; var i = $(this)
          var j = i.data('position')
          var k = b.data('position')
          var l = a.data()
  ...
  private: {
    init: function (a) {
      var b; var c; var d = a.find('thead tr th')
    ...
    createMouseMoveHandler: function (a, b) {
      return function (c) {
        ...
        a.data('dragReady') && (a.data('dragReady', !1), d = a.clone(), e = b.index(), a.addClass('gj-unselectable'), $('body').append(d), d.attr('data-role', 'draggable-clone').css('cursor', 'move'), d.find('thead tr th:eq(' + e + ')').siblings().remove(), d.find('tbody tr[data-role != "row"]').remove(), d.find('tbody tr td:nth-child(' + (e + 1) + ')').siblings().remove(), d.find('tfoot').remove(), d.draggable({
          ...
          width: b.width(),
          zIndex: 1
        }), b.attr('data-droppable') === 'true' && b.droppable('destroy'), b.siblings('th').each(function () {
          var c = $(this)
          c.attr('data-droppable') === 'true' && c.droppable('destroy'), c.droppable({
    ...
    createDragStopHandler: function (a, b) {
      return function (c, d) {
        $('table[data-role="draggable-clone"]').draggable('destroy').remove(), a.removeClass('gj-unselectable'), b.siblings('th').each(function () {
          var c = $(this)
          var e = a.data()
          var f = gj.grid.methods.getColumnPosition(e.columns, c.data('field'))
          var g = gj.grid.methods.getColumnPosition(e.columns, b.data('field'))
    ...
    moveRowCells: function (a, b, c) {
      var d; var e; var f = a.find('tbody tr[data-role="row"]')
  ...
  private: {
    init: function (a) {
      var b; var c; var d; var e = a.data()
      var f = $('<tr data-role="filter"/>')
      for (b = 0; b < e.columns.length; b++) {
        c = $('<th/>'), e.columns[b].filterable && (d = $('<input data-field="' + e.columns[b].field + '" class="gj-width-full" />'), e.headerFilter.type === 'onchange' ? d.on('input propertychange', function (b) {
          gj.grid.plugins.headerFilter.private.reload(a, $(this))
        }) : (d.on('keypress', function (b) {
          b.which == 13 && gj.grid.plugins.headerFilter.private.reload(a, $(this))
  ...
  private: {
    init: function (a) {
      ...
      b = void 0, a.on('rowDataBound', function (d, e, f, g) {
        if (b !== g[c.grouping.groupBy] || e[0].rowIndex === 1) {
          ...
          var i = $('<tr role="group" />')
          var j = $('<td class="gj-text-align-center gj-unselectable gj-cursor-pointer" />')
    ...
    createExpandCollapseHandler: function (a) {
      return function (b) {
        var c = $(this)
        var d = gj.grid.plugins.grouping.private
        c.closest('tr').next(':visible').data('role') === 'row' ? d.collapseGroup(a, c) : d.expandGroup(a, c)
      }
    },
  ...
  render: function (a, b) {
    return b && (typeof b === 'string' && JSON && (b = JSON.parse(b)), a.data('records', gj.tree.methods.getRecords(a, b)), gj.tree.methods.loadData(a)), a
  },
  filter: function (a) {
    return a.data().dataSource
  },
  getRecords: function (a, b) {
    var c; var d; var e; var f = []
    var g = a.data()
  ...
  appendNode: function (a, b, c, d, e) {
    var f; var g; var h; var i; var j; var k = a.data()
    var g = $('<li data-id="' + c.id + '" data-role="node" />').addClass(k.style.item)
    var l = $('<div data-role="wrapper" />')
    var m = $('<span data-role="expander" data-mode="close"></span>').addClass(k.style.expander)
    var n = $('<span data-role="display">' + c.data[k.textField] + '</span>')
    var o = void 0 !== c.data[k.hasChildrenField] && c.data[k.hasChildrenField].toString().toLowerCase() === 'true'
    var p = void 0 !== c.data[k.disabledField] && c.data[k.disabledField].toString().toLowerCase() === 'true'
    if (k.indentation && l.append('<span data-role="spacer" style="width: ' + k.indentation * (d - 1) + 'px;"></span>'), p ? gj.tree.methods.disableNode(a, g) : (m.on('click', gj.tree.methods.expanderClickHandler(a)), n.on('click', gj.tree.methods.displayClickHandler(a))), l.append(m), l.append(n), g.append(l), e ? b.find('li:eq(' + (e - 1) + ')').before(g) : b.append(g), c.children.length || o) { for (m.empty().append(k.icons.expand), h = $('<ul />').addClass(k.style.list).addClass('gj-hidden'), g.append(h), f = 0; f < c.children.length; f++) gj.tree.methods.appendNode(a, h, c.children[f], d + 1) } else k.style.leafIcon ? m.addClass(k.style.leafIcon) : m.html('&nbsp;')
  ...
  expand: function (a, b, c) {
    var d; var e; var f = b.find('>[data-role="wrapper"]>[data-role="expander"]')
    var g = a.data()
    var h = b.attr('data-id')
    var i = b.children('ul')
  ...
  displayClickHandler: function (a) {
    return function (b) {
      var c = $(this)
      var d = c.closest('li')
      var e = a.data().cascadeSelection
      d.attr('data-selected') === 'true' ? gj.tree.methods.unselect(a, d, e) : (a.data('selectionType') === 'single' && gj.tree.methods.unselectAll(a), gj.tree.methods.select(a, d, e))
    }
  },
  selectAll: function (a) {
    var b; var c = a.find('ul>li')
  ...
  select: function (a, b, c) {
    var d; var e; var f = a.data()
    if (b.attr('data-selected') !== 'true' && !1 !== gj.tree.events.select(a, b, b.attr('data-id')) && (b.addClass(f.style.active).attr('data-selected', 'true'), c)) { for (e = b.find('ul>li'), d = 0; d < e.length; d++) gj.tree.methods.select(a, $(e[d]), c) }
  },
  unselectAll: function (a) {
    var b; var c = a.find('ul>li')
  ...
  unselect: function (a, b, c) {
    var d, e
    a.data()
    if (b.attr('data-selected') === 'true' && !1 !== gj.tree.events.unselect(a, b, b.attr('data-id')) && (b.removeClass(a.data().style.active).removeAttr('data-selected'), c)) { for (e = b.find('ul>li'), d = 0; d < e.length; d++) gj.tree.methods.unselect(a, $(e[d]), c) }
  },
  getSelections: function (a) {
    var b; var c; var d; var e = []
    var f = a.children('li')
    if (f && f.length) { for (b = 0; b < f.length; b++) c = $(f[b]), c.attr('data-selected') === 'true' ? e.push(c.attr('data-id')) : c.has('ul') && (d = gj.tree.methods.getSelections(c.children('ul')), d.length && (e = e.concat(d))) }
    return e
  },
  ...
  enableNode: function (a, b, c) {
    var d; var e; var f = b.find('>[data-role="wrapper"]>[data-role="expander"]')
    var g = b.find('>[data-role="wrapper"]>[data-role="display"]')
    var c = void 0 === c || c
  ...
  }, $.extend(a, c), a.attr('data-type') !== 'tree' && d.init.call(a, b), a
...
(function (a) {
  ...
  private: {
    dataBound: function (a) {
      ...
      a.data('cascadeCheck') && (b = a.find('li[data-role="node"]'), $.each(b, function () {
        var a = $(this)
        var b = a.find('[data-role="checkbox"] input[type="checkbox"]').checkbox('state')
        b === 'checked' && (gj.tree.plugins.checkboxes.private.updateChildrenState(a, b), gj.tree.plugins.checkboxes.private.updateParentState(a, b))
      }))
    },
    nodeDataBound: function (a, b, c, d) {
      var e = a.data()
      var f = b.find('> [data-role="wrapper"] > [data-role="expander"]')
      var g = $('<input type="checkbox"/>')
      var h = $('<span data-role="checkbox"></span>').append(g)
      var i = void 0 !== d[e.disabledField] && d[e.disabledField].toString().toLowerCase() === 'true'
      g = g.checkbox({
    ...
    updateParentState: function (a, b) {
      var c, d, e, f, g, h
      c = a.parent('ul').parent('li'), c.length === 1 && (d = a.parent('ul').parent('li').find('> [data-role="wrapper"] > [data-role="checkbox"] input[type="checkbox"]'), e = a.siblings().find('> [data-role="wrapper"] > span[data-role="checkbox"] input[type="checkbox"]'), f = b === 'checked', g = b === 'unchecked', h = 'indeterminate', $.each(e, function () {
        var a = $(this).checkbox('state')
        f && a !== 'checked' && (f = !1), g && a !== 'unchecked' && (g = !1)
  ...
  public: {
    getCheckedNodes: function () {
      var a = []
      var b = this.find('li [data-role="checkbox"] input[type="checkbox"]')
      return $.each(b, function () {
        var b = $(this)
        b.checkbox('state') === 'checked' && a.push(b.closest('li').data('id'))
      }), a
    },
    checkAll: function () {
  ...
  private: {
    nodeDataBound: function (a, b) {
      ...
      var d = b.find('>[data-role="wrapper"]>[data-role="display"]')
    ...
    createNodeMouseMoveHandler: function (a, b, c) {
      return function (d) {
        if (a.data('dragReady')) {
          var e; var f; var g; var h; var i = a.data()
          ...
          }), c.attr('data-droppable') === 'true' && c.droppable('destroy'), gj.tree.plugins.dragAndDrop.private.getTargetDisplays(a, b, c).each(function () {
            var a = $(this)
            a.attr('data-droppable') === 'true' && a.droppable('destroy'), a.droppable()
    ...
    createDragHandler: function (a, b, c) {
      ...
      var e = gj.tree.plugins.dragAndDrop.private.getTargetWrappers(a, b)
      var f = a.data()
    ...
    createDragStopHandler: function (a, b, c) {
      ...
      return function (c, g) {
        ...
        $(this).draggable('destroy').remove(), d.each(function () {
          var c; var d; var e; var i = $(this)
          if (i.droppable('isOver', g)) return c = i.closest('li'), d = b.parent('ul').parent('li'), e = c.children('ul'), e.length === 0 && (e = $('<ul />').addClass(f.style.list), c.append(e)), !1 !== gj.tree.plugins.dragAndDrop.events.nodeDrop(a, b.data('id'), c.data('id'), e.children('li').length + 1) && (e.append(b), gj.tree.plugins.dragAndDrop.private.refresh(a, b, c, d)), h = !0, !1
          i.droppable('destroy')
        }), h || e.each(function () {
          var c; var d; var e; var f; var h; var i = $(this)
    ...
    refreshNode: function (a, b) {
      var c = b.children('[data-role="wrapper"]')
      var d = c.children('[data-role="expander"]')
      var e = c.children('[data-role="spacer"]')
      var f = b.children('ul')
      var g = a.data()
      var h = b.parentsUntil('[data-type="tree"]', 'ul').length
  ...
  private: {
    ...
    createDoneHandler: function (a, b) {
      return function (c) {
        var d; var e; var f; var g = a.data()
        if (typeof c === 'string' && JSON && (c = JSON.parse(c)), c && c.length) {
    ...
    expand: function (a, b, c) {
      ...
      var f = {}
      var g = b.find('>ul>li')
      g && g.length || typeof e.dataSource === 'string' && (f[e.paramNames.parentId] = c, d = {
        url: e.dataSource,
        data: f
  ...
  state: function (a, b) {
    return b ? (b === 'checked' ? (a.prop('indeterminate', !1), a.prop('checked', !0)) : b === 'unchecked' ? (a.prop('indeterminate', !1), a.prop('checked', !1)) : b === 'indeterminate' && (a.prop('checked', !0), a.prop('indeterminate', !0)), gj.checkbox.events.change(a, b), a) : b = a.prop('indeterminate') ? 'indeterminate' : a.prop('checked') ? 'checked' : 'unchecked'
  },
  toggle: function (a) {
    return a.state() == 'checked' ? a.state('unchecked') : a.state('checked'), a
  },
  destroy: function (a) {
    return a.attr('data-checkbox') === 'true' && (a.removeData(), a.removeAttr('data-guid'), a.removeAttr('data-checkbox'), a.off(), a.next('span').remove(), a.unwrap()), a
  }
}, gj.checkbox.events = {
  change: function (a, b) {
  ...
  return c.toggle = function () {
    ...
    return d.destroy(this)
  }, $.extend(a, c), a.attr('data-checkbox') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a) {
    var b; var c; var d; var e; var f; var g = this
    var h = a.data()
    if (a.hide(), a[0].parentElement.attributes.role !== 'wrapper' && (d = document.createElement('div'), d.setAttribute('role', 'wrapper'), a[0].parentNode.insertBefore(d, a[0]), d.appendChild(a[0])), gj.editor.methods.localization(h), $(d).addClass(h.style.wrapper), h.width && $(d).width(h.width), e = $(d).children('div[role="body"]'), e.length === 0 && (e = $('<div role="body"></div>'), $(d).append(e), a[0].innerText && (e[0].innerHTML = a[0].innerText)), e.attr('contenteditable', !0), e.on('keydown', function (b) {
      var c = event.keyCode || event.charCode
      !1 === gj.editor.events.changing(a) && c !== 8 && c !== 46 && b.preventDefault()
    }), e.on('mouseup keyup mouseout cut paste', function (b) {
      g.updateToolbar(a, f), gj.editor.events.changed(a), a.html(e.html())
    }), f = $(d).children('div[role="toolbar"]'), f.length === 0) {
  ...
  updateToolbar: function (a, b) {
    ...
    $buttons = b.find('[role]').each(function () {
      var a = $(this)
      var b = a.attr('role')
      b && document.queryCommandEnabled(b) && document.queryCommandValue(b) === 'true' ? a.addClass(c.style.buttonActive) : a.removeClass(c.style.buttonActive)
    })
  },
  ...
  destroy: function (a) {
    var b
    return a.attr('data-editor') === 'true' && (b = a.parent(), b.children('div[role="body"]').remove(), b.children('div[role="toolbar"]').remove(), a.unwrap(), a.removeData(), a.removeAttr('data-guid'), a.removeAttr('data-editor'), a.off(), a.show()), a
  }
}, gj.editor.events = {
  changing: function (a) {
  ...
  var c = this
  var d = gj.editor.methods
  return c.content = function (a) {
    return d.content(this, a)
  }, c.destroy = function () {
    return d.destroy(this)
  }, $.extend(a, c), a.attr('data-editor') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a) {
    var b = a.data()
    var c = a.parent('div[role="wrapper"]')
    var d = $('<span role="display"></span>')
    var e = $('<span role="expander">' + b.icons.dropdown + '</span>').addClass(b.style.expander)
    var f = $('<button role="presenter" type="button"></button>').addClass(b.style.presenter)
    var g = $('<ul role="list" class="' + b.style.list + '"></ul>').attr('guid', a.attr('data-guid'))
    c.length === 0 ? (c = $('<div role="wrapper" />').addClass(b.style.wrapper), a.wrap(c)) : c.addClass(b.style.wrapper), b.fontSize && f.css('font-size', b.fontSize), f.on('click', function (b) {
  ...
  setListPosition: function (a, b, c) {
    var d; var e; var f; var g; var h = a.getBoundingClientRect()
    var i = window.scrollY || window.pageYOffset || 0
  ...
  filter: function (a) {
    var b; var c; var d = a.data()
    if (d.dataSource) {
      if (typeof d.dataSource[0] === 'string') { for (b = 0; b < d.dataSource.length; b++) c = {}, c[d.valueField] = d.dataSource[b], c[d.textField] = d.dataSource[b], d.dataSource[b] = c }
    } else d.dataSource = []
    return d.dataSource
  },
  render: function (a, b) {
    ...
    var d = a.data()
    var e = a.parent()
    var f = $('body').children('[role="list"][guid="' + a.attr('data-guid') + '"]')
    var g = e.children('[role="presenter"]')
    var h = (g.children('[role="expander"]'), g.children('[role="display"]'))
    if (a.data('records', b), a.empty(), f.empty(), b && b.length) {
      if ($.each(b, function () {
        var b; var e = this[d.valueField]
        var g = this[d.textField]
        var h = this[d.selectedField] && this[d.selectedField].toString().toLowerCase() === 'true'
      ...
      }), c.length === 0) a.prepend('<option value=""></option>'), d.placeholder && (h[0].innerHTML = '<span class="placeholder">' + d.placeholder + '</span>')
  ...
  open: function (a, b) {
    var c = a.data()
    var d = a.parent().find('[role="expander"]')
    var e = a.parent().find('[role="presenter"]')
  ...
  select: function (a, b) {
    var c = a.data()
    var d = $('body').children('[role="list"][guid="' + a.attr('data-guid') + '"]')
    var e = d.children('li[value="' + b + '"]')
    var f = gj.dropdown.methods.getRecordByValue(a, b)
  ...
  return c.value = function (a) {
    ...
    return d.destroy(this)
  }, $.extend(a, c), a.attr('data-dropdown') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a, b) {
    var c; var d; var e = a.parent('div[role="wrapper"]')
    d = b.uiLibrary === 'bootstrap' ? $('<span class="input-group-addon">' + b.icons.rightIcon + '</span>') : b.uiLibrary === 'bootstrap4' ? $('<span class="input-group-append"><button class="btn btn-outline-secondary border-left-0" type="button">' + b.icons.rightIcon + '</button></span>') : $(b.icons.rightIcon), d.attr('role', 'right-icon'), e.length === 0 ? (e = $('<div role="wrapper" />').addClass(b.style.wrapper), a.wrap(e)) : e.addClass(b.style.wrapper), e = a.parent('div[role="wrapper"]'), b.width && e.css('width', b.width), a.val(b.value).addClass(b.style.input).attr('role', 'input'), b.fontSize && a.css('font-size', b.fontSize), b.uiLibrary === 'bootstrap' || b.uiLibrary === 'bootstrap4' ? b.size === 'small' ? (e.addClass('input-group-sm'), a.addClass('form-control-sm')) : b.size === 'large' && (e.addClass('input-group-lg'), a.addClass('form-control-lg')) : b.size === 'small' ? e.addClass('small') : b.size === 'large' && e.addClass('large'), d.on('click', function (c) {
  ...
  createCalendar: function (a, b) {
    var c; var d; var e; var f; var g; var h = $('<div role="calendar" type="month"/>').addClass(b.style.calendar).attr('guid', a.attr('data-guid'))
    return b.fontSize && h.css('font-size', b.fontSize), c = gj.core.parseDate(b.value, b.format, b.locale), !c || isNaN(c.getTime()) ? c = new Date() : a.attr('day', c.getFullYear() + '-' + c.getMonth() + '-' + c.getDate()), h.attr('month', c.getMonth()), h.attr('year', c.getFullYear()), gj.datepicker.methods.renderHeader(a, h, b, c), d = $('<div role="body" />'), h.append(d), b.footer && (e = $('<div role="footer" class="' + b.style.footer + '" />'), f = $('<button class="' + b.style.button + '">' + gj.core.messages[b.locale].cancel + '</button>'), f.on('click', function () {
      ...
      var c; var d; var e = h.attr('selectedDay')
  ...
  renderMonth: function (a, b, c) {
    var d; var e; var f; var g; var h; var i; var j; var k; var l; var m; var n; var o; var p; var q; var r; var s = b.children('[role="body"]')
    var t = $('<table/>')
    var u = $('<tbody/>')
    for (s.off().empty(), gj.datepicker.methods.createNavigation(a, s, t, c), g = parseInt(b.attr('month'), 10), h = parseInt(b.attr('year'), 10), b.attr('type', 'month'), b.find('div[role="period"]').text(gj.core.messages[c.locale].monthNames[g] + ' ' + h), i = new Array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31), h % 4 == 0 && h != 1900 && (i[1] = 29), j = i[g], k = (new Date(h, g, 1).getDay() + 7 - c.weekStartDay) % 7, d = 0, $row = $('<tr />'), n = gj.datepicker.methods.getPrevMonth(g, h), l = 1; l <= k; l++) {
    ...
    for (l > 1 && u.append($row), m = new Date(), l = 1; l <= j; l++) {
      r = new Date(h, g, l), d == 0 && ($row = $('<tr>'), c.calendarWeeks && $row.append('<td class="calendar-week"><div>' + gj.datepicker.methods.getWeekNumber(r) + '</div></td>')), p = $('<td day="' + l + '" month="' + g + '" year="' + h + '" />'), h === m.getFullYear() && g === m.getMonth() && l === m.getDate() ? p.addClass('today') : p.addClass('current-month'), q = $('<div>' + l + '</div>'), gj.datepicker.methods.isSelectable(c, r) ? (p.addClass('gj-cursor-pointer'), q.on('click', gj.datepicker.methods.dayClickHandler(a, b, c, r)), q.on('mousedown', function (a) {
        a.stopPropagation()
      })) : p.addClass('disabled'), p.append(q), $row.append(p), ++d == 7 && (u.append($row), d = 0)
    }
  ...
  renderYear: function (a, b, c) {
    var d; var e; var f; var g; var h = b.find('>[role="body"]>table')
    var i = h.children('tbody')
  ...
  renderDecade: function (a, b, c) {
    var d; var e; var f; var g; var h; var i = b.find('>[role="body"]>table')
  ...
  getMinDate: function (a) {
    var b
    return a.minDate && (typeof a.minDate === 'string' ? b = gj.core.parseDate(a.minDate, a.format, a.locale) : typeof a.minDate === 'function' ? typeof (b = a.minDate()) === 'string' && (b = gj.core.parseDate(b, a.format, a.locale)) : typeof a.minDate.getMonth === 'function' && (b = a.minDate)), b
  },
  getMaxDate: function (a) {
    var b
    return a.maxDate && (typeof a.maxDate === 'string' ? b = gj.core.parseDate(a.maxDate, a.format, a.locale) : typeof a.maxDate === 'function' ? typeof (b = a.maxDate()) === 'string' && (b = gj.core.parseDate(b, a.format, a.locale)) : typeof a.maxDate.getMonth === 'function' && (b = a.maxDate)), b
  },
  isSelectable: function (a, b) {
    var c; var d = !0
    var e = gj.datepicker.methods.getMinDate(a)
    var f = gj.datepicker.methods.getMaxDate(a)
    if (e && b < e ? d = !1 : f && b > f && (d = !1), d) {
      if (a.disableDates) {
        if ($.isArray(a.disableDates)) { for (c = 0; c < a.disableDates.length; c++) a.disableDates[c] instanceof Date && a.disableDates[c].getTime() === b.getTime() ? d = !1 : typeof a.disableDates[c] === 'string' && gj.core.parseDate(a.disableDates[c], a.format, a.locale).getTime() === b.getTime() && (d = !1) } else a.disableDates instanceof Function && (d = a.disableDates(b))
      }
  ...
  prev: function (a, b) {
    return function () {
      var c; var d; var e; var f; var g; var h = $('body').find('[role="calendar"][guid="' + a.attr('data-guid') + '"]')
      switch (h.attr('type')) {
        case 'month':
  ...
  change: function (a, b, c, d) {
    ...
    var f = d.getFullYear()
    var g = gj.core.formatDate(d, c.format, c.locale)
    b.attr('month', e), b.attr('year', f), a.val(g), gj.datepicker.events.change(a), window.getComputedStyle(b[0]).display !== 'none' && gj.datepicker.methods.close(a)
  },
  ...
  }, $.extend(a, c), a.attr('data-datepicker') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a, b) {
    var c; var d = a.parent('div[role="wrapper"]')
    c = b.uiLibrary === 'bootstrap' ? $('<span class="input-group-addon">' + b.icons.rightIcon + '</span>') : b.uiLibrary === 'bootstrap4' ? $('<span class="input-group-append"><button class="btn btn-outline-secondary border-left-0 border" type="button">' + b.icons.rightIcon + '</button></span>') : $(b.icons.rightIcon), c.attr('role', 'right-icon'), d.length === 0 ? (d = $('<div role="wrapper" />').addClass(b.style.wrapper), a.wrap(d)) : d.addClass(b.style.wrapper), d = a.parent('div[role="wrapper"]'), b.width && d.css('width', b.width), a.val(b.value).addClass(b.style.input).attr('role', 'input'), b.uiLibrary === 'bootstrap' || b.uiLibrary === 'bootstrap4' ? b.size === 'small' ? (d.addClass('input-group-sm'), a.addClass('form-control-sm')) : b.size === 'large' && (d.addClass('input-group-lg'), a.addClass('form-control-lg')) : b.size === 'small' ? d.addClass('small') : b.size === 'large' && d.addClass('large'), c.on('click', function (b) {
  ...
  createClock: function (a) {
    var b; var c = a.data()
    var d = $('<div role="clock" />').addClass(c.style.clock).attr('guid', a.attr('data-guid'))
    var e = $('<div role="hour" />')
    var f = $('<div role="minute" />')
    var g = $('<div role="header" />')
    var h = $('<div role="mode" />')
    var i = $('<div role="body" />')
    var j = $('<button class="' + c.style.button + '">' + gj.core.messages[c.locale].ok + '</button>')
    var k = $('<button class="' + c.style.button + '">' + gj.core.messages[c.locale].cancel + '</button>')
    var l = $('<div role="footer" class="' + c.style.footer + '" />')
    ...
    }), g.append(e).append(':').append(f), c.mode === 'ampm' && (h.append($('<span role="am">' + gj.core.messages[c.locale].am + '</span>').on('click', function () {
  ...
  setTime: function (a, b) {
    return function () {
      ...
      var d = gj.timepicker.methods.getMinute(b)
      var e = b.attr('mode')
      var f = new Date(0, 0, 0, c === 12 && e === 'am' ? 0 : c, d)
      var g = a.data()
      var h = gj.core.formatDate(f, g.format, g.locale)
      a.value(h), a.close()
    }
  },
  getPointerValue: function (a, b, c) {
    var d; var e; var f = 256
    var g = Math.atan2(f / 2 - a, f / 2 - b) / Math.PI * 180
    switch (g < 0 && (g = 360 + g), c) {
      case 'ampm':
        return d = 12 - Math.round(12 * g / 360), d === 0 ? 12 : d
      case '24hr':
        return e = Math.sqrt(Math.pow(f / 2 - a, 2) + Math.pow(f / 2 - b, 2)), d = 12 - Math.round(12 * g / 360), d === 0 && (d = 12), e < f / 2 - 32 && (d = d === 12 ? 0 : d + 12), d
      case 'minutes':
        return d = Math.round(60 - 60 * g / 360), d === 60 ? 0 : d
    }
  },
  updateArrow: function (a, b, c, d) {
    var e; var f; var g = b.mouseX(a)
    var h = b.mouseY(a)
    var i = window.scrollY || window.pageYOffset || 0
    var j = window.scrollX || window.pageXOffset || 0
    e = a.target.getBoundingClientRect(), d.dialMode == 'hours' ? (f = gj.timepicker.methods.getPointerValue(g - j - e.left, h - i - e.top, d.mode), c.attr('hour', d.mode === 'ampm' && c.attr('mode') === 'pm' && f < 12 ? f + 12 : f)) : d.dialMode == 'minutes' && (f = gj.timepicker.methods.getPointerValue(g - j - e.left, h - i - e.top, 'minutes'), c.attr('minute', f)), gj.timepicker.methods.update(b, c, d)
  },
  update: function (a, b, c) {
    var d, e, f, g, h, i
    d = gj.timepicker.methods.getHour(b), e = gj.timepicker.methods.getMinute(b), f = b.find('[role="arrow"]'), c.dialMode == 'hours' && (d == 0 || d > 12) && c.mode === '24hr' ? f.css('width', 'calc(50% - 52px)') : f.css('width', 'calc(50% - 20px)'), c.dialMode == 'hours' ? f.css('transform', 'rotate(' + (30 * d - 90).toString() + 'deg)') : f.css('transform', 'rotate(' + (6 * e - 90).toString() + 'deg)'), f.show(), g = c.mode === 'ampm' && d > 12 ? d - 12 : d == 0 ? 12 : d, i = b.find('[role="body"] span'), i.removeClass('selected'), i.filter(function (a) {
      return c.dialMode == 'hours' ? parseInt($(this).text(), 10) == g : parseInt($(this).text(), 10) == e
    }).addClass('selected'), c.header && (h = b.find('[role="header"]'), h.find('[role="hour"]').text(g), h.find('[role="minute"]').text(gj.core.pad(e)), c.mode === 'ampm' && (d >= 12 ? (h.find('[role="pm"]').addClass('selected'), h.find('[role="am"]').removeClass('selected')) : (h.find('[role="am"]').addClass('selected'), h.find('[role="pm"]').removeClass('selected'))))
  },
  ...
  mouseUpHandler: function (a, b, c) {
    return function (d) {
      gj.timepicker.methods.updateArrow(d, a, b, c), a.mouseMove = !1, c.modal || (clearTimeout(a.timeout), a.focus()), c.dialMode == 'hours' ? setTimeout(function () {
        gj.timepicker.events.select(a, 'hour'), gj.timepicker.methods.renderMinutes(a, b, c)
      }, 1e3) : c.dialMode == 'minutes' && (!0 !== c.footer && !1 !== c.autoClose && gj.timepicker.methods.setTime(a, b)(), gj.timepicker.events.select(a, 'minute'))
    }
  },
  renderHours: function (a, b, c) {
    var d; var e = b.find('[role="body"]')
  ...
  open: function (a) {
    var b; var c; var d = a.data()
    var e = $('body').find('[role="clock"][guid="' + a.attr('data-guid') + '"]')
  ...
  destroy: function (a) {
    var b = a.data()
    var c = a.parent()
    var d = $('body').find('[role="clock"][guid="' + a.attr('data-guid') + '"]')
  ...
  }, $.extend(a, c), a.attr('data-timepicker') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  initialize: function (a) {
    var b; var c; var d; var e; var f; var g; var h; var i; var j = a.data()
    j.datepicker.uiLibrary = j.uiLibrary, j.datepicker.iconsLibrary = j.iconsLibrary, j.datepicker.width = j.width, j.datepicker.format = j.format, j.datepicker.locale = j.locale, j.datepicker.modal = j.modal, j.datepicker.footer = j.footer, j.datepicker.style.calendar = j.style.calendar, j.datepicker.value = j.value, j.datepicker.size = j.size, j.datepicker.autoClose = !1, gj.datepicker.methods.initialize(a, j.datepicker), a.on('select', function (c, d) {
      var e, f
      d === 'day' ? gj.datetimepicker.methods.createShowHourHandler(a, b, j)() : d === 'minute' && b.attr('selectedDay') && !0 !== j.footer && (selectedDay = b.attr('selectedDay').split('-'), e = new Date(selectedDay[0], selectedDay[1], selectedDay[2], b.attr('hour') || 0, b.attr('minute') || 0), f = gj.core.formatDate(e, j.format, j.locale), a.val(f), gj.datetimepicker.events.change(a), gj.datetimepicker.methods.close(a))
    }), a.on('open', function () {
  ...
  var c = this
  var d = gj.datetimepicker.methods
  return c.mouseMove = !1, c.value = function (a) {
    return d.value(this, a)
  }, c.destroy = function () {
    return d.destroy(this)
  }, $.extend(a, c), a.attr('data-datetimepicker') !== 'true' && d.init.call(a, b), a
...
(function (a) {
  ...
  createMouseMoveHandler: function (a, b, c, d, e) {
    return function (d) {
      var f, g, h, i, j, k, l
      c.getAttribute('drag') === 'true' && (f = gj.core.position(a[0], !0, !0), g = (new gj.widget()).mouseX(d) - f.left, h = gj.core.width(b), i = gj.core.width(c) / 2, j = h / (e.max - e.min), k = (e.value - e.min) * j, g >= i && g <= h + i && (g > k + j / 2 || g < k - j / 2) && (l = Math.round((g - i) / j) + e.min, gj.slider.methods.value(a, e, l)))
    }
  },
  ...
  var c = this
  var d = gj.slider.methods
  return c.value = function (a) {
    return d.value(this, this.data(), a)
  }, c.destroy = function () {
    return d.destroy(this)
  }, $.extend(a, c), a.attr('data-slider') !== 'true' && d.init.call(a, b), a
