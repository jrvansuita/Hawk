module.exports= class PendingEmailTemplate {
  ...
  constructor(){
    ...
    this.tail = "<p><br>Estaremos aguardando 24hrs por seu retorno, caso não tenhamos retorno, iremos escolher algo com muito carinho para substituir. <br><br>Caso deseje trocá-lo, basta entrar em contato.<br>Dúvidas estamos a disposição!<br><br>Equipe Boutique Infantil.</p>";
